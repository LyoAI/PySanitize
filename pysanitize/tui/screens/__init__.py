...
wizard sense (① Fields → ② Options → ③ Image → ④ Run → ⑤ Results), kept as
tabs so the user can move back and forth without losing state.
"""
...
__all__ = ["FieldsPane", "ImagePane", "OptionsPane", "ResultsPane", "RunPane"]
